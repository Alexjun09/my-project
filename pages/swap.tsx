        ...
        <>
            ...
            <main className='bg-green-700 h-screen'>
                ...
                <div className='flex flex-row'>
                    <div className='h-screen w-10'> {/* social media bar*/}
                        <div className='mt-80'>
                            <div className=''>
                    ...
                    <div className='ml-[38%]'>
                        <h1 className='text-center text-7xl m-10 mt-20'><b>SWAP</b></h1>
                        <div className='flex flex-col bg-green-300 rounded-2xl text-green-700'>
                            <div className='flex flex-row m-2'>
                                ...
                                <div className='w-2/4 text-right'>
                                    <button className='px-2 bg-green-100 rounded-full m-1 my-2'>S</button>
                                    <button className='px-2 bg-green-100 rounded-full m-1 my-2'>A</button>
                                    <button className='px-2 bg-green-100 rounded-full m-1 my-2'>R</button>
                                </div>
                            </div>
                            <p className='w-[100%] text-sm text-right -ml-2'>Trade tokens in an instant.</p>
                            <div>
                                <div className='flex flex-row pt-2 px-2'>
                                    <label className='bg-green-100 p-2 px-4 rounded-t-xl' htmlFor="">WBNB</label>
                                    <p className='w-full text-right text-white'>Balance: 0.00</p>
                                </div>
                                <div className='px-2'>
                                    <input className='bg-green-100 p-1 rounded-b-xl rounded-r-xl w-full h-16' type="number" />
                                </div>
                                <div className='my-3 mx-2 text-sm'>
                                    <span className='bg-green-100 rounded-3xl px-6 mx-2'>25%</span>
                                    <span className='bg-green-100 rounded-3xl px-6 mx-2'>50%</span>
                                    <span className='bg-green-100 rounded-3xl px-6 mx-2'>75%</span>
                                    <span className='bg-green-100 rounded-3xl px-6 mx-2'>MAX</span>
                                </div>
                                <div className='flex flex-row pt-2 px-2'>
                                    <label className='bg-green-100 p-2 px-4 rounded-t-xl' htmlFor="">WBNB</label>
                                    <p className='w-full text-right text-white'>Balance: 0.00</p>
